    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-8 py-12">
      <div className="w-full max-w-6xl mx-auto grid grid-cols-2 gap-16">
        ...
        <div className="flex flex-col">
          <form id="user-info-form" onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-xs text-gray-500">
              Project authors: Elias Hedlin, Fauzan Helmi, Malin Hall, and Robin Scholle.<br></br>Questions? <a href="mailto:robp@kth.se" className="text-blue-600 hover:underline">robp@kth.se</a> | <a href="https://www.kth.se/student/kurser/kurs/DM2730?l=en" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Course Info</a>
            </div>
          </form>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-red-50 border rounded-lg p-6 mb-8" style={{ borderColor: '#82181a' }}>
            <div className="flex gap-3">
              <div className="flex-shrink-0">
                <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center">
                  <Info className="w-4 h-4" style={{ color: '#82181a' }} />
                </div>
              </div>
              <div>
                <p className="text-sm font-bold mb-2" style={{ color: '#82181a' }}>Important!</p>
                <p className="text-sm font-semibold mb-2" style={{ color: '#82181a' }}>
                  For this test it is crucial that you show your line of sight with the cursor of your mouse.
                </p>
                <p className="text-sm" style={{ color: '#82181a' }}>
